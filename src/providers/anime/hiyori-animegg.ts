...
class Hiyori extends AnimeBase {
  override name: string = 'hiyori'
  override url = 'https://www.animegg.org'
  override providerType: ('H-SUB' | 'SUB' | 'DUB')[] = ['H-SUB', 'DUB']

  private provider = Anime.AnimeGG(this.apiKey)
