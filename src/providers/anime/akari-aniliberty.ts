...
class Akari extends AnimeBase {
  override name: string = 'akari'
  override url = 'https://aniliberty.top'
  override providerType: ('H-SUB' | 'SUB' | 'DUB')[] = ['DUB']

  private provider = Anime.Aniliberty(this.apiKey)
