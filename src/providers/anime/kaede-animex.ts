...
class Kaede extends AnimeBase {
  override name: string = 'kaede'
  override url: string = 'https://animex.one/'
  override providerType: ('H-SUB' | 'SUB' | 'DUB')[] = ['H-SUB', 'SUB', 'DUB']

  public override client: KyInstance = ky.create({
    prefixUrl: 'https://api.crysoline.moe/api/anime/animex',
    headers: {
